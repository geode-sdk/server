use crate::endpoints::developers::{SimpleDevMod, SimpleDevModVersion};
...
use super::developer::{Developer, FetchedDeveloper};
use super::incompatibility::{Replacement, ResponseIncompatibility};
