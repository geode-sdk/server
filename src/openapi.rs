...
#[openapi(
    paths(
        ...
        endpoints::mod_version_submissions::get_submission,
        endpoints::mod_version_submissions::update_submission,
        endpoints::mod_version_submissions::get_comments,
        endpoints::mod_version_submissions::create_comment,
        endpoints::mod_version_submissions::update_comment,
        endpoints::mod_version_submissions::delete_comment,
        endpoints::mod_version_submissions::get_attachments,
        endpoints::mod_version_submissions::upload_attachments,
        endpoints::mod_version_submissions::delete_attachment,
    ...
    components(
        schemas(
            ...
            types::models::mod_version_submission::ModVersionSubmission,
            types::models::mod_version_submission::ModVersionSubmissionComment,
            types::models::mod_version_submission::UpdateSubmissionPayload,
            types::models::mod_version_submission::CreateCommentPayload,
            types::models::mod_version_submission::UpdateCommentPayload,
            types::models::mod_version_submission::ModVersionSubmissionAttachment,
    ...
    tags(
        ...
        (name = "mod_version_submissions", description = "Mod version submission and review endpoints"),
