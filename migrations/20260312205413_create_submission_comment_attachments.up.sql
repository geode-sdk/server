...
CREATE INDEX idx_submission_attachments_comment_id ON mod_version_submission_comment_attachments (comment_id);

-- For fast COUNT lookups on delete (deduplication check)
CREATE INDEX idx_submission_attachments_filename ON mod_version_submission_comment_attachments (filename);
